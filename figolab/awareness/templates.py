...
<style>
body{{margin:0;min-height:100vh;display:grid;place-items:center;font-family:Segoe UI,system-ui,sans-serif;background:#0f1419;color:#e8eef5}}
.card{{width:min(520px,92vw);background:#1a222c;border:1px solid #2b3642;border-radius:14px;padding:28px 24px;line-height:1.55}}
...
def render_context(config: Any) -> dict[str, str]:
